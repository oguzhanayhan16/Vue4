<template>
    <div class="home"><h1>All destinations</h1>
...
export default {
  ...
  methods:{
    async triggerRouterError(){
      const navigatinFailure = await this.$router.push('/')
      if(isNavigationFailure(navigatinFailure,NavigationFailureType.duplicated)){
        console.log(navigatinFailure.to)
        console.log(navigatinFailure.from)
      }
      else{
